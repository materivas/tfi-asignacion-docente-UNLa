...
-- 2. Insertar Materia
INSERT INTO materia (id, nombre, plan_id) VALUES (1, 'Matemáticas I', 1) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO asignacion (id, materia_id, cuatrimestre_id, turno, anio) VALUES (1, 1, 1, 'Mañana', 2025) ON CONFLICT (id) DO NOTHING;
